        ...
        <div>
            ...
            <div className='w-5/6 mx-auto my-16 mb-36'>
                <div className='grid grid-cols-4 gap-12'>
                    ...
                    <div className='col-span-3 text-white text-left flex flex-col gap-8'>
                            ...
                            <div className='flex flex-col gap-6'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <div className=''>
                                        ...
                                        <p className='text-[14px] font-[300]'>Giving your home a new style every style</p>
                                    </div>
                                </div>
                                <ul>
                                    <li className='flex items-center gap-2'><IoMdCheckmarkCircleOutline className='text-[23px] text-primary' /> <p className='text-[13px] leading-[30px]'>We provide high quality design services.</p> </li>
                                    <li className='flex items-center gap-2'><IoMdCheckmarkCircleOutline className='text-[23px] text-primary' /> <p className='text-[13px] leading-[30px]'>Project on time and Latest Design.</p> </li>
                                    <li className='flex items-center gap-2'><IoMdCheckmarkCircleOutline className='text-[23px] text-primary' /> <p className='text-[13px] leading-[30px]'>Scientific Skills For getting a better result.</p> </li>
                                    <li className='flex items-center gap-2'><IoMdCheckmarkCircleOutline className='text-[23px] text-primary' /> <p className='text-[13px] leading-[30px]'>Renovations Benefit of Service</p> </li>
                                    <li className='flex items-center gap-2'><IoMdCheckmarkCircleOutline className='text-[23px] text-primary' /> <p className='text-[13px] leading-[30px]'>We are confident about our projects.</p> </li>
                                </ul>
                            </div>
                            <div>
