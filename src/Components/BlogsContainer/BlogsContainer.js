                ...
                <div className='col-span-2'>
                    <div onMouseLeave={() => setMousein(false)} onMouseEnter={() => setMousein(parseInt(1))} className='flex flex-col gap-8 bg-[#151515] mx-5 shadow-xl mb-8 text-left'>
                        ...
                        <div className='px-10 mb-10 flex flex-col gap-6'>
                            ...
                            <p className='text-white'>I neglect my talents Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language</p>
                        </div>
                    </div>
