                ...
                <div className='grid grid-cols-4 gap-12'>
                    <div className='col-span-1 text-white flex flex-col gap-6'>
                        <div className='text-left px-4 py-8 bg-[#333]'>
                            <p className='mb-4 text-xl border-b border-accent pb-2  text-secondary'>More Services</p>
                            <div className='flex flex-col gap-4'>
                                <Link className='hover:bg-primary text-black duration-300 hover:text-white bg-white p-3'>Architecture</Link>
                                <Link className='hover:bg-primary duration-300 hover:text-white bg-primary p-3 text-white'>Interior Work</Link>
                                <Link className='hover:bg-primary duration-300 hover:text-white bg-white p-3 text-black'>Planning</Link>
                            </div>
                        </div>
                        <div className='text-left px-4 py-8 bg-[#333]'>
                            <p className='mb-4 text-xl border-b border-accent pb-2 text-secondary'>Contact</p>
                            <div className='flex flex-col gap-4'>
                        ...
                        <div className='text-left px-6 py-8 bg-[#333]'>
                            <p className='mb-4 text-xl border-b border-accent pb-2 text-secondary'>Gallery</p>
                    ...
                    <div className='col-span-3 text-left flex flex-col gap-8'>
                        <img src={deptPic1} alt="" />
                        <div className='flex flex-col gap-2 text-[17px] leading-relaxed font-[300] text-accent'>
                            <p className='text-3xl leading-normal font-[500] text-secondary jose-font'>About Interior Services</p>
                        ...
                        <div className='flex items-center mt-4 gap-12'>
                            <div className='flex flex-col gap-3 items-start basis-10/12 text-accent'>
                                <p className='text-3xl font-[500] text-secondary jose-font'>Fully Trained Employees</p>
                                <p className='text-[17px] leading-relaxed font-[300] jose-font'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accuswqo doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo et inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. loream inventore veritatis et quasi architecto beatae vitae dicta sunt sed ut the perspiciatis unde omnis iste natus error sit majority have suffeed voluptatem injectd humour, or randomised ws which ly believable.</p>
                        ...
                        <div className='flex items-center mt-4 gap-12'>
                            ...
                            <div className='flex flex-col gap-3 items-start basis-10/12 text-accent'>
                                <p className='text-3xl font-[500] text-secondary jose-font'>Quality Maintain Every Time</p>
                                <p className='text-[17px] leading-relaxed font-[300] jose-font'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accuswqo doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo et inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. loream inventore veritatis et quasi architecto beatae vitae dicta sunt sed ut the perspiciatis unde omnis iste natus error sit majority have suffeed voluptatem injectd humour, or randomised ws which ly believable.</p>
                                <Link className='btn border-primary border-2 bg-transparent text-primary font-normal rounded-none mt-6 hover:bg-primary hover:border-transparent hover:text-black'>Read More</Link>
                            </div>
                        </div>

                        <p className='text-3xl leading-normal font-[500] mb-1 mt-8 text-secondary jose-font'>Words From Our Customers</p>
