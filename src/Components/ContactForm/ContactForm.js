...
const ContactForm = () => {
    return (
        <div className='relative'>
            <p className='absolute text-secondary rotate-90 right-[-40px] top-[50%] bottom-[50%] text-[15px]'>CONTACTS US</p>
            <div className='w-5/6 mx-auto'>
                ...
                <div className='grid grid-cols-3 my-20 gap-8'>
                    <div className='col-span-1 flex flex-col gap-6 text-left text-secondary'>
                        <div className=''>
                            <p className='text-[18px] font-[600] mb-[3px]'>ADDRESS:</p>
                            <p className='text-[14px] text-accent'>991 White St . Dawsonville GA 30534 , New York</p>
                        </div>
                        <div className=''>
                            <p className='text-[18px] font-[600] mb-[3px]'>PHONE NUMBER:</p>
                            <p className='text-[14px] text-accent'>+ (898) 784-7217</p>
                        </div>
                        <div className=''>
                            <p className='text-[18px] font-[600] mb-[3px]'>EMAIL:</p>
                            <p className='text-[14px] text-accent'>Tatee.architecture@gmail.com</p>
                        </div>
                    </div>
                    <div className='col-span-2'>
                        <form>
                            ...
                            <input className='mt-8 w-full border-0 bg-primary text-white p-[1rem] rounded-none cursor-pointer btn hover:bg-primary' type="submit" value='SUBMIT NOW' />
                        </form>
                    </div>
                </div>
            </div>
