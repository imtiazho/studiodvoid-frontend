        ...
        <div>
            ...
            <div className='my-20 w-[75%] mx-auto'>
                <div style={{ background: `url(${projectMainPic1})`, backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", objectFit: "cover" }} className='w-full h-[600px] flex justify-center items-center relative'>
                    <div className='bg-secondary p-12 flex flex-col gap-5 text-left text-neutral absolute bottom-[-150px] shadow-xl'>
                        <p className='text-xl font-[600]'>Project Details:</p>
                        <div className='grid grid-cols-2 gap-24'>
                            <div>
                                <p className='text-lg font-[500] mb-[2px]'>Project</p>
                                <p className='text-[14px]'>Outdoor Paint</p>
                            </div>
                            <div>
                                <p className='text-lg font-[500] mb-[2px]'>Clients</p>
                                <p className='text-[14px]'>Jimmy Divison</p>
                            </div>
                        </div>
                        <div className='grid grid-cols-2 gap-24'>
                            <div>
                                <p className='text-lg font-[500] mb-[2px]'>Location</p>
                                <p className='text-[14px]'>Miranda, USA</p>
                            </div>
                            <div>
                ...
                <div className='mt-[13rem] text-[#bfbfbf] text-left'>
                    ...
                    <div>
                        <p className='text-2xl font-[500] mb-4 text-[#ddd]'>Project Challenge</p>
                        <p className='text-[13px] leading-loose'>It’s time to put on makeup. It’s time to dress up right. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. It’s time to raise the curtain on the Muppet Show tonight. The mate was a mighty sailin’ man the Skipper brave and sure.</p>

                        <div className='my-8 grid grid-cols-2'>
                            <ul className='flex flex-col gap-2'>
                                <li className='flex items-center gap-2'><BsCheck className='text-[23px] text-primary' /> <p className='text-[13px] leading-loose'>Five passengers set sail that day for a three </p></li>
                                <li className='flex items-center gap-2'><BsCheck className='text-[23px] text-primary' /> <p className='text-[13px] leading-loose'>Family that’s the way we all became the brady</p> </li>
                                <li className='flex items-center gap-2'><BsCheck className='text-[23px] text-primary' /> <p className='text-[13px] leading-loose'>Now were up in the big leagues getting’ turn</p> </li>
                            </ul>
                            <ul className='flex flex-col gap-2'>
                                <li className='flex items-center gap-2'><BsCheck className='text-[23px] text-primary' /> <p className='text-[13px] leading-loose'>Till the one day when the lady met this fellow</p> </li>
                                <li className='flex items-center gap-2'><BsCheck className='text-[23px] text-primary' /> <p className='text-[13px] leading-loose'>Champion the cause of the innocent career</p> </li>
                                <li className='flex items-center gap-2'><BsCheck className='text-[23px] text-primary' /> <p className='text-[13px] leading-loose'>The powerless in a world of criminals operate</p> </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className='mt-8'>
                        ...
                        <p className='text-[13px] leading-loose'>Then along come two they got nothin’ but their jeans. Texas tea. Knight Rider: A shadowy flight into the dangerous world of a man who does not exist. The first mate and his Skipper too will do their very best to make the tropic island nest.</p>
                    </div>

                    <div className='my-8'>
                        <p className='text-2xl font-[500] mb-4 text-[#ddd]'>Result</p>
                        <p className='text-[13px] leading-loose'>That’s just a little bit more than the law will allow. We’re gonna do it. On your mark get set and go now. Got a dream and we just know now we’re gonna make our dream come true. Makin their way the only way they know how. That’s just a little bit more than the law will allow.</p>
                    </div>
