    ...
    return (
        <div className='w-9/12 pt-10 mx-auto grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1'>
            <motion.div
                ...
                className='xl:py-40 py-12 px-8 flex flex-col md:gap-6 gap-4 text-accent xl:border-l md:border-0 border-b pb-8 md:pb-0 border-[#272727]'
            >
            ...
            <motion.div
                ...
                className='xl:py-40 py-12 px-8 flex flex-col md:gap-6 gap-4 text-accent xl:border-l xl:border-r border-[#272727]'
            >
                <div className='md:px-14 px-12'>
