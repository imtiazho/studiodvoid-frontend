...
const Planning = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Planning | StudioDvoid</title>
      </Helmet>
      <NavBar />
      <PageBanner
        banner={PlanningBanner}
        moto={"Planning"}
        subTitle={"About our Planning work up"}
      />
        ...
        <div className="grid xl:grid-cols-4 grid-cols-1 gap-12">
          <div className="xl:col-span-1 text-secondary flex flex-col gap-6 xl:order-1 order-2">
            <div className="text-left px-4 py-8 bg-[#333]">
              <p className="mb-4 md:text-xl text-[17px] border-b border-secondary pb-2 text-secondary">
                More Services
              </p>
              <div className="flex flex-col gap-4">
                <Link
                  to="/architecture-page"
                  className="hover:bg-primary duration-300 hover:text-white bg-white p-3 text-black md:text-[15px] text-[13px]"
                >
                  Architecture
                </Link>
                <Link
                  to="/interiorWork-page"
                  className="hover:bg-primary duration-300 hover:text-white bg-white text-black p-3 md:text-[15px] text-[13px]"
                >
                  Interior Work
                </Link>
                <Link
                  to="/planning-page"
                  className="hover:bg-primary duration-300 hover:text-white bg-primary text-white p-3 md:text-[15px] text-[13px]"
                >
                  Planning
                </Link>
              </div>
            ...
            <div className="text-left px-4 py-8 bg-[#333]">
              ...
              <div className="flex flex-col gap-4">
                <div className="bg-white p-3 text-black flex items-center gap-4">
                  ...
                  <div>
                    <p className="md:text-[15px] text-[13px] font-[500] mb-[2px]">
                      Phone Number
                    </p>
                    <p className="md:text-[14px] text-[11px] text-someDeep">
                      +123 456 7890
                    </p>
                  </div>
                </div>
                <div className="bg-white p-3 text-black flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[15px] text-someDeep">
                      info@abcmail.com
                    </p>
                  </div>
                </div>
          ...
          <div className="xl:col-span-3 text-accent text-left flex flex-col gap-6 xl:order-2 order-1">
            ...
            <div className="flex flex-col gap-2 md:text-[17px] text-[15px] md:leading-relaxed leading-normal font-[300] text-accent">
              <p className="lg:text-3xl md:text-[25px] text-[22px] leading-normal font-[600] jose-font text-secondary jose-font">
                Creative Solutions By Inoterior Professional Designers
              </p>
              <p className="jose-font">
                ...
                natural stone. Give your consent, we design a perfect bend
                choose the style, we complete with our file.
              </p>
              <p className="jose-font">
                A wonderful serenity has taken possession of my entire soul,
                like these sweet mornings of spring which I enjoy with my whole
                heart and its very blessed.
              </p>
            </div>
            <div>
              <p className="lg:text-3xl md:text-[25px] text-[22px] leading-normal font-[600] jose-font text-secondary jose-font">
              ...
              <p className="md:text-[17px] text-[15px] md:leading-relaxed leading-normal font-[300] jose-font">
            ...
            <div>
              ...
              <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-12 gap-6 lg:my-12 mt-9 lg:mt-0">
                <div
                  ...
                  className="relative object-cover mb-2 overflow-hidden"
                >
                  <img
                    className={`${mousein === 6 && "scale-110"} duration-500 object-cover relative`}
                    src={planningWorkUpPic1}
                    alt="Pic"
                  />
                  {mousein === 6 && (
                    <span className="absolute bg-black opacity-70 w-full h-full bottom-0 duration-500"></span>
                  )}
                  {mousein === 6 && (
                    <div className="flex flex-col items-start justify-start h-full w-full absolute bottom-0 text-white">
                      <div className="m-6 border border-accent p-6 flex flex-col justify-between h-full items-start">
                        <div>
                          <p className="text-[23px] font-[500] mb-2 jose-font">
                            Modern Kitchen
                          </p>
                          <p className="text-[17px] font-[300] jose-font">
                            The style of the interior was defined as modern in
                            light colors. Main materials used in project are
                            wallpaper etc.
                          </p>
                        </div>
                        <Link className="btn border-primary border-2 bg-transparent text-primary font-normal rounded-none mt-10 hover:bg-primary hover:border-transparent hover:text-black">
                          Read More +
                        </Link>
                      </div>
                    </div>
                ...
                >
                  <img
                    className={`${mousein === 1 && "scale-110"} duration-500 object-cover relative`}
                    src={planningWorkUpPic2}
                    alt="Pic"
                  />
                  {mousein === 1 && (
                    <span className="absolute bg-black opacity-70 w-full h-full bottom-0 duration-500"></span>
                    ...
                    <div className="flex flex-col items-start justify-start h-full w-full absolute bottom-0 text-white">
                      <div className="m-6 border border-accent p-6 flex flex-col justify-between h-full items-start">
                        <div>
                          ...
                          <p className="text-[17px] font-[300] jose-font">
                            The entire interior is the beginning of the history
                            of the house, such as colors, lighting, and
                            materials.
                          </p>
                        </div>
                        <Link className="btn border-primary border-2 bg-transparent text-primary font-normal rounded-none mt-10 hover:bg-primary hover:border-transparent hover:text-black">
            ...
            <p className="md:text-3xl text-[25px] leading-normal font-[500] mb-1 mt-8 jose-font">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-16 gap-12">
              <div className="border border-[#353535] flex flex-col gap-4 p-6 relative client-card">
                ...
                <p className="text-[15px] font-[300] italic text-accent jose-font">
                  I love everything that put together for my living room! I just
                  bought this house and only had a few items I wanted to keep.
                  I’am able to help me visualize the room”
                </p>
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className="md:text-[17px] text-[15px] mb-1">
                      Natalie Kameron
                    </p>
                    <p className="md:text-[14px] text-[12px] font-[200] text-accent jose-font">
                      Ceo / Manger
                    </p>
                  </div>
                </div>
