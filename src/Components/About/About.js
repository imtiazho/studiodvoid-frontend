        ...
        <div>
            ...
            <div className='pt-44 text-left'>
                ...
                <div className='grid grid-cols-2 w-5/6 mx-auto'>
                    <div className='grid grid-cols-2 gap-6'>
                        <div className='text-white'>
                            ...
                            <p className='text-[12px] tracking-widest mb-2 text-white'>YEARS OF EXPERIENCE</p>
                        </div>
                        <div className='text-white'>
                            <p className='text-4xl mb-3 font-bold'>126 +</p>
                            <p className='text-[12px] tracking-widest mb-2 text-white'>HAPPY CLIENTS</p>
                        </div>
                        <div className='text-white'>
                            <p className='text-4xl mb-3 font-bold'>224 +</p>
                            <p className='text-[12px] tracking-widest mb-2 text-white'>COMPLETED PROJECTS</p>
                        </div>
                        <div className='text-white'>
                            <p className='text-4xl mb-3 font-bold'>16 +</p>
                            <p className='text-[12px] tracking-widest mb-2 text-white'>DESIGN ARWARDS</p>
                        </div>
                    </div>
                ...
                <div className='text-center w-5/6 mt-24 mx-auto'>
                    <p className='text-[12px] tracking-widest mb-2 text-white'>WHAT WE DO</p>
                    <h1 className='text-5xl font-bold text-white'>Our specilization</h1>
                ...
                <div style={{ background: `url(${bgPattern})`, backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", objectFit: "cover" }} className='my-20'>
                    <div className='grid grid-cols-4 mx-auto w-5/6 items-center'>
                        <div className='col-span-1'>
                            <p className='text-[12px] tracking-[4px] mb-2 text-white'>AWESOME PARTNER</p>
                            <p className='text-[42px] mt-2 text-white font-[600]'>Our Clients</p>
                        </div>
                ...
                <div className='w-[80%] mx-auto'>
                    <div className='col-span-1 text-center'>
                        <p className='text-[12px] tracking-[4px] mb-2 text-white'>AWESOME PEOPLE</p>
                        <p className='text-[42px] mt-2 text-white font-[600]'>Meet the team</p>
                    </div>
                    ...
                    <div className='grid grid-cols-3 gap-16 mt-16 mb-36'>
                        <div className="card items-center">
                            ...
                            <div className='text-center mt-5'>
                                <Link className='text-white text-xl font-[500] uppercase'>SONJA PORTER</Link>
                                <p className='text-white text-[15px]'><small>Co-manage Associated</small></p>
                            </div>
                        </div>
                        <div className="card items-center">
                            ...
                            <div className='text-center mt-5'>
                                <Link className='text-white text-xl font-[500] uppercase'>MARION LAWSON</Link>
                                <p className='text-white text-[15px]'><small>Interior Desinger</small></p>
                            </div>
                        </div>
                        <div className="card items-center">
                            ...
                            <div className='text-center mt-5'>
                                <Link className='text-white text-xl font-[500] uppercase'>Brad Green</Link>
                                <p className='text-white text-[15px]'><small>CEO - Main Architect</small></p>
                            </div>
                        </div>
                        <div className="card items-center">
                            ...
                            <div className='text-center mt-5'>
                                <Link className='text-white text-xl font-[500] uppercase'>KIM HARRINGTON</Link>
                                <p className='text-white text-[15px]'><small>Architect - Photographer</small></p>
                            </div>
                        </div>
                        <div className="card items-center">
                            ...
                            <div className='text-center mt-5'>
                                <Link className='text-white text-xl font-[500] uppercase'>TYRONE CURTIS</Link>
                                <p className='text-white text-[15px]'><small>Architect - Designer</small></p>
                            </div>
                        </div>
                        <div className="card items-center">
                            ...
                            <div className='text-center mt-5'>
                                <Link className='text-white text-xl font-[500] uppercase'>JODI RIVERA</Link>
                                <p className='text-white text-[15px]'><small>Interior Designer</small></p>
                            </div>
                        </div>
                    </div>
                </div>
