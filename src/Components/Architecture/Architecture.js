...
const Architecture = () => {
  return (
    <div>
      <Helmet>
        <title>Architecture | StudioDvoid</title>
      </Helmet>
      <NavBar />
      <PageBanner
        banner={ArchitectBanner}
        moto={"Architecture"}
        subTitle={"About our Architect work up"}
      />
      {/* Here main start */}
      <div className="2xl:w-5/6 w-[90%] mx-auto lg:my-16 my-28 mb-36">
        <div className="grid xl:grid-cols-4 grid-cols-1 gap-12">
            ...
            <div className="text-left px-4 py-8 bg-[#333]">
              ...
              <div className="flex flex-col gap-4">
                <Link
                  ...
                  className="hover:bg-primary duration-300 hover:text-white bg-primary text-white p-3 text-black md:text-[15px] text-[13px]"
                >
                  Architecture
                </Link>
                <Link
                  to="/interiorWork-page"
                  className="hover:bg-primary duration-300 hover:text-white text-black bg-white p-3 md:text-[15px] text-[13px]"
                >
                  Interior Work
                </Link>
                <Link
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-white p-3 text-black flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="md:text-[15px] text-[12px] text-someDeep">
                      info@abcmail.com
                    </p>
                  </div>
                </div>
          ...
          <div className="xl:col-span-3 text-secondary text-left flex flex-col gap-8 xl:order-2 order-1">
            <p className="lg:text-3xl md:text-[25px] text-[22px] leading-normal font-[500] md:mb-1">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 items-center mt-4">
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <div className="">
                    <p className="md:text-[22px] text-[20px] font-[500]">
                      Use of Interior
                    </p>
                    <p className="md:text-[14px] text-[12px] font-[300] jose-font">
                ...
                <ul className="text-accent">
                  <li className="flex items-center gap-2">
                    <IoMdCheckmarkCircleOutline className="text-[23px] text-primary" />{" "}
                    <p className="ms:text-[14px] text-[13px] leading-[30px] jose-font">
