    ...
    return (
        <div className='py-48 w-[95%] mx-auto flex flex-col gap-16'>
            <div className='grid grid-cols-2 gap-16 items-center'>
                ...
                <div className='items-start text-left flex flex-col gap-4 text-secondary order-2'>
                    ...
                    <p className='text-[12px] w-[90%] my-6 leading-loose text-accent'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque still laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi arch sat itecto beatae vitae dicta sunt explicabo.</p>
            ...
            <div className='grid grid-cols-2 gap-16 items-center'>
                ...
                <div className='items-start text-left flex flex-col gap-4 text-secondary order-1'>
                    <p className='uppercase text-[12px] tracking-[6px]'>ARCHITECTURE</p>
                    <div className='relative'>
