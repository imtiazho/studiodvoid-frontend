                ...
                <div className='grid grid-cols-4 gap-12'>
                    ...
                    <div className='col-span-3 text-white text-left flex flex-col gap-8'>
                        ...
                        <div className='flex flex-col gap-2 text-[15px] leading-relaxed font-[300]'>
                            <p className='text-3xl leading-normal font-[500]'>About Interior Services</p>
                        ...
                        <div className='flex items-center mt-4 gap-12'>
                            <div className='flex flex-col gap-3 items-start basis-10/12'>
                                <p className='text-3xl font-[500]'>Fully Trained Employees</p>
                                <p className='text-[14px] leading-loose font-[300]'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accuswqo doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo et inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. loream inventore veritatis et quasi architecto beatae vitae dicta sunt sed ut the perspiciatis unde omnis iste natus error sit majority have suffeed voluptatem injectd humour, or randomised ws which ly believable.</p>
                        ...
                        <div className='flex items-center mt-4 gap-12'>
                            ...
                            <div className='flex flex-col gap-3 items-start basis-10/12'>
                                <p className='text-3xl font-[500]'>Quality Maintain Every Time</p>
                                <p className='text-[14px] leading-loose font-[300]'>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accuswqo doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo et inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. loream inventore veritatis et quasi architecto beatae vitae dicta sunt sed ut the perspiciatis unde omnis iste natus error sit majority have suffeed voluptatem injectd humour, or randomised ws which ly believable.</p>
                                <Link className='btn border-primary border-2 bg-transparent text-primary font-normal rounded-none mt-6 hover:bg-primary hover:border-transparent hover:text-black'>Read More</Link>
                            </div>
                        </div>
